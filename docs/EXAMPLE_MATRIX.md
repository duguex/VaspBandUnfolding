...
| X6 | `examples/bseplot/co2_demo/` | `bash run_realspace.sh` | ok | l2-partial | CO2 self-consistent realspace |
| X6b | `examples/bseplot/mose2_recompute/` | `bash run_realspace.sh` | ok | l2-partial | MoSe2 6x6x1 recompute; needs local VASP/WAVECAR |
