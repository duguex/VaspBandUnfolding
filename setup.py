...
PY_MODULES = ['vasp_constant', 'vaspwfc', 'aewfc', 'nac', 'unfold', 'procar', 'spinorb', 'spinor', 'sph_harm', 'paw', 'ewald', 'bsefatband', 'bsematrix', 'wfull', 'waveder', 'spline', 'band_order', 'hse_kpts']
